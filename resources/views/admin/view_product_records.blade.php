    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                ...
                <div class="ms-auto">
                    <span class="badge bg-gradient-orange text-white rounded-pill px-3 py-2">{{ $products->count() }} Total</span>
                </div>
            </div>
            <!--end breadcrumb-->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(($product->stock_quantity ?? 0) <= 0)
                                            <span class="badge bg-gradient-bloody text-white rounded-pill px-3">Out of Stock</span>
                                        @elseif(($product->stock_quantity ?? 0) < 10)
                                            <span class="badge bg-gradient-blooker text-white rounded-pill px-3">{{ $product->stock_quantity }} Left</span>
                                        @else
                                            <span class="badge bg-gradient-lush text-white rounded-pill px-3">{{ $product->stock_quantity }} In Stock</span>
                                        @endif
                                    </td>
